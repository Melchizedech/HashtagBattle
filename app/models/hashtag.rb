class Hashtag < ActiveRecord::Base
  ...
  def update_count(user:, at: Time.now, force: false)
    ...
    return if daily_count.is_fresh?(at: at) && !force
    count, last_tweet_id = TwitterInterface.query_hashtag(user, name, at, daily_count.last_tweet_id)
